						...
						<strong>
							<span style={{ fontSize: '15px' }}>
								<span data-custom-class="subtitle">
									Last updated <bdt className="question">September 08, 2021</bdt>
								</span>
							</span>
						</strong>
					</span>
					...
					<span style={{ color: 'rgb(127, 127, 127)' }}>
						<span style={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }}>
							<span data-custom-class="body_text">
								...
								<bdt className="question">sqrt(-1)8 sum pi</bdt>
							...
							<span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
								<span data-custom-class="body_text">
									...
									<bdt className="question">
										<a
											href="https://devmuscles.netlify.app/"
											target="_blank"
											data-custom-class="link"
										>
											https://devmuscles.netlify.app/
										</a>
									</bdt>
									<span style={{ fontSize: '15px' }}>
										<span style={{ color: 'rgb(89, 89, 89)' }}>
														...
														<span data-custom-class="body_text">
															...
															<span style={{ fontSize: '15px' }}>
																<span style={{ color: 'rgb(89, 89, 89)' }}>
																	<span data-custom-class="body_text">
																		<bdt className="block-component" />
																		<bdt className="question">akashkhambay@hotmail.co.uk</bdt>
																									...
																									>
																										...
																										>
																											<span data-custom-class="body_text">
																												...
																												your personal information. To make such a
																										...
																										>
																											...
																											>
																												<span data-custom-class="body_text">
																													...
																													we may still communicate with you, for
																													example to send you service-related emails
																													that are necessary for the administration
																												...
																												<span style={{ color: 'rgb(48, 48, 241)' }}>
																													<span data-custom-class="body_text">
																														<span style={{ fontSize: '15px' }}>
																															<a
																																data-custom-class="link"
																																href="https://app.termly.io/notify/f178082e-c2b8-4f53-be7c-7be2446d6a46"
																																rel="noopener noreferrer"
																																target="_blank"
																															>
																																here
